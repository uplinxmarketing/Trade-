...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        #    stop_loss and smart_hold are forced OFF on every restart — the user
        #    opts in each session. trading_active is preserved so a running bot
        #    resumes after a redeploy.
        _s = _load_strategy()
        _auto_patch: dict = {
            "pause_reason":       None,
